...
SECRET_KEY = 'django-insecure-+e&*#rw@7a=vvsx+t8(8ek85x-#^*bfek(x24w!bgxjfyxv5sq'
...
WSGI_APPLICATION = 'Kenya_KCSE_portal.wsgi.application'
...
# URL to handle media served from MEDIA_ROOT
MEDIA_URL = '/media/'
